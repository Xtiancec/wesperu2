...
function listar(){
	...
	tabla=$('#tbllistado').dataTable({
		...
		"ajax":
		{
			url:'../controlador/um.php?op=listar',
			type: "get",
			dataType : "json",
			error:function(e){
...
function mostrar(idUM){

	$.ajax({
		data:{"idUM":idUM},
		url:'../controlador/um.php?op=mostrar',
		type:"post",
		beforeSend:function(){},
...
function guardar(){
	...
	$.ajax({
		data: parametros,
		url: '../controlador/um.php?op=guardar',
		type: "POST",
		beforeSend:function(){},
		success:function(response){
			if(response == "success"){
...
function Actualizar(){
	...
	parametros ={"idUM":idUM,"nombre":nombre,"descripcion":descripcion}
	$.ajax({
		data: parametros,
		url: '../controlador/um.php?op=editar',
		type: "POST",
		beforeSend: function(){},
		success:function(response){
...
function confirmarEliminacion(idUM) {
...
function desactivar(idUM) {
	$.ajax({
		data: { "idUM": idUM },
		url: '../controlador/um.php?op=desactivar',
		type: "POST",
		beforeSend: function () { }
...
//funcion para desactivar
function confirmarActivacion(idUM) {
...
function activar(idUM) {
	$.ajax({
		data: { "idUM": idUM },
		url: '../controlador/um.php?op=activar',
		type: "POST",
		beforeSend: function () { }
	});
}
