...
function listar(){
	...
	tabla=$('#tbllistado').dataTable({
		...
		"ajax":
		{
			url:'../controlador/tipocomprobante.php?op=listar',
			type: "get",
			dataType : "json",
			error:function(e){
...
function mostrar(idTipocomprobante){

	$.ajax({
		data:{"idTipocomprobante":idTipocomprobante},
		url:'../controlador/tipocomprobante.php?op=mostrar',
		type:"post",
		beforeSend:function(){},
		success: function(response){
			console.log(response)
			data=$.parseJSON(response);
				$("#idTipocomprobanteUpdate").val(data['idTipocomprobante']);
...
function guardar(){
	...
	$.ajax({
		data: parametros,
		url: '../controlador/tipocomprobante.php?op=guardar',
		type: "POST",
		beforeSend:function(){},
		success:function(response){
			if(response == "success"){
...
function Actualizar(){
	idTipocomprobante=$('#idTipocomprobanteUpdate').val();
	nombre=$('#nombreUpdate').val();
	parametros ={"idTipocomprobante":idTipocomprobante,"nombre":nombre}
	$.ajax({
		data: parametros,
		url: '../controlador/tipocomprobante.php?op=editar',
		type: "POST",
		beforeSend: function(){},
		success:function(response){
...
function confirmarEliminacion(idTipocomprobante) {
...
function desactivar(idTipocomprobante) {
	$.ajax({
		data: { "idTipocomprobante": idTipocomprobante },
		url: '../controlador/tipocomprobante.php?op=desactivar',
		type: "POST",
		beforeSend: function () { }
...
//funcion para desactivar
function confirmarActivacion(idTipocomprobante) {
...
function activar(idTipocomprobante) {
	$.ajax({
		data: { "idTipocomprobante": idTipocomprobante },
		url: '../controlador/tipocomprobante.php?op=activar',
		type: "POST",
		beforeSend: function () { }
	});
}
