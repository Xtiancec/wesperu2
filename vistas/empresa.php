                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-lg-5 col-md-5 col-xs-5">
                                                            ...
                                                            <div class="input-group">
                                                                <input type="number" id="RUC" nombre="RUC" maxlength="11" class="form-control" placeholder="INGRESE EL RUC">
                                                                <span class="input-group-btn">
                                                                    <button id="buscarRUC" class="btn btn-info" type="button">BUSCAR</button>
                                                                </span>
                                                            </div>
                                                            <!--<input class="form-control" type="hidden" id="idEmpresa" nombre="idEmpresa">
                                                            <input class="form-control" type="number" id="RUC" nombre="RUC" maxlength="11" placeholder="DIGITE EL RUC" required>
